...
TEST(ABI, encodeDynamicType)
{
  ...
  bytes strVal = bytes(65, 0);
  vector<bytes> values = {fromHex("0x11"), fromHex("0xff"), strVal, fromHex("0x01")};
  bytes d = encodeABI("", types, values);
  EXPECT_EQ(d, fromHex(""));
}
